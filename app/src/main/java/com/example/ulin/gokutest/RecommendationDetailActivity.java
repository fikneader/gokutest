...
public class RecommendationDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ingredientIds = getIntent().getStringExtra(IngredientsActivity.EXTRA_INGREDIENT_IDS);
    ...
    private class GetRecipeDetailTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String response) {
            try {
                ...
                try {
                    ...
                    String[] ingredientIdArray = ingredientIds.split(",");
                    ...
                    if(ingredientView != null) {
                        ...
                        for (int i = 0; i < nIngredients; i++) {
                            ...
                            if(isExist(ingredientIdArray,ingredient.optString("kd_bahan"))) {
        ...
        private boolean isExist(String[] array, String id) {
