...
public class RecommendationActivity extends FragmentActivity implements RecipeFragment.OnListFragmentInteractionListener{
    //PART 1 MENU & SEARCH
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.ulin.gokutest.R.layout.activity_recommendation);
        //1
        ...
        if (extras != null) {
            ingredientIds = extras.getString(IngredientsActivity.EXTRA_INGREDIENT_IDS);
        }
    ...
    private void search(final String keyword) {
        if(findViewById(com.example.ulin.gokutest.R.id.listRecipe) != null){
            ...
            if(networkInfo != null && networkInfo.isConnected()){
                String parameters = "bahan=" + ingredientIds;
                String url = "http://goku.ngeartstudio.com/services/rekomendasi.php";
                Log.i("INUL",parameters);
    ...
    public void onListFragmentInteraction(Recipe item){
        ...
        intent.putExtra(RecommendationDetailActivity.EXTRA_RECIPE_ID, item.id+"");
        intent.putExtra(IngredientsActivity.EXTRA_INGREDIENT_IDS, ingredientIds);
